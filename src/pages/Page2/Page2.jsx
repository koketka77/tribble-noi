...
const Page2 = () => {
    return (
        <div >
           <div className='allbigpics'></div>
           <div className='text'><p>CNN
 — 
...
But setting a species loose in the wild is a precarious balancing act. Reintroductions often take years and involve multiple phases, says Natasha Robinson, an ecologist at the Australian National University who specializes in threatened wildlife.</p></div>
        </div>
    );
}
